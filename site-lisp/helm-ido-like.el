;;; helm-ido-like.el -- intuitive and more ido-like helm interface

;;; Commentary:

;; Guide to get an intuitive and more ido-like helm interface in Emacs.
;; Recommends configurations and packages to improve helms default interface.
;;
;; see https://github.com/compunaut/helm-ido-like-guide
...
(defun helm-ido-like-load-ido-like-bottom-buffer ()
  "Use a full width bottom buffer."
...
(defun helm-ido-like-bottom-buffers-init ()
  "Configures helm buffers modeline."
