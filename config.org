...
** Ido setup
   ...
   #+begin_src emacs-lisp :tangle yes
     (use-package ido
       :bind (("H-b" . ido-switch-buffer))
       :customize
       (ido-file-extensions-order
        '(".cpp" ".m" ".h" ".java" ".c" ".el" ".rb" "CMakeLists.txt")
   ...
   Enable smex for ido like alternative to M-x.
...
** Common configuration
   ...
   #+begin_src emacs-lisp :tangle yes
     (use-package projectile
       ...
       (defun maybe-projectile-grep ()
         "Call projectile grep when in a managed project, rgrep otherwise."
         (interactive)
         (call-interactively
          (if (projectile-project-p)
              #'projectile-grep #'rgrep)))
       (projectile-mode t))
   #+end_src
